...
summary: An arcade shooter in the classic mould — escalating waves, tight controls, and a scoring loop built to make you try one more run.
order: 85
year: '2024'
kind: Game
...
feature list and all of it is the difference between a game that feels responsive
and one that feels like it is arguing with you.
